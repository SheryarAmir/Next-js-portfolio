      ...
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="">
            ...
            {/* Description */}
            <p className="mt-6 text-sm md-text-base text-white text-opacity-60 2xl:text-lg xl:">
          ...
          {/* Image content */}
          <div className="mx-auto hidden lg:block rounded-[3rem] border-[3.5px] border-blue-950 overflow-x-hidden xl:mt-[20px] ">
